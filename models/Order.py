...
class OrderItem:
    """OrderItem Entity - Represents an item in an order (immutable snapshot)"""
    ...
    def __init__(self, order_id: str, product_id: str, quantity: int, unit_price: float,
        ...
        self.unit_price = unit_price  # Snapshot price at time of order
...
class Order:
    ...
    def get_total(self) -> float:
        """Get total amount (should match total_amount)"""
